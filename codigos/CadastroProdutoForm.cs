...
namespace PotirendabaApp.Forms
{
    public class CadastroProdutoForm : Form
    {
        ...
        private void InitUI()
        {
            ...
            _txtNome.PlaceholderText = "Nome do produto";
            _txtNome.TabIndex = 1;
            ...
            _txtValor = MakeTxt(330, 172, 154, soLeitura:false);
            _txtValor.PlaceholderText = "Ex: 9.99";
            _txtValor.TabIndex = 3;
            ...
            _txtEstoque = MakeTxt(10, 172, 210, soLeitura:false);
            _txtEstoque.PlaceholderText = "Quantidade";
            _txtEstoque.TabIndex = 2;
        ...
        private void PreencherIdAutomatico()
        {
            ...
            int proximo = 1;
            foreach (var p in todos) if (p.Id >= proximo) proximo = p.Id + 1;
            _txtId.Text = proximo.ToString();
        }

        private void PreencherCampos()
        {
            _txtId.Text       = _produtoEdicao.Id.ToString();
            _txtNome.Text     = _produtoEdicao.Nome;
            _txtData.Text     = _produtoEdicao.Data;
            _txtValor.Text    = _produtoEdicao.Valor.ToString("F2");
            _txtEstoque.Text  = _produtoEdicao.Estoque.ToString();
            _chkAtivo.Checked = _produtoEdicao.Ativo;
            _chkAtivo.ForeColor = _produtoEdicao.Ativo
                ? Color.FromArgb(34,130,55) : Vermelho;
        }
        ...
        private bool Validar()
        {
            ...
            if (!string.IsNullOrWhiteSpace(_txtValor.Text)) {
                ...
                if (!decimal.TryParse(vs,System.Globalization.NumberStyles.Any,
                    ...
                    MessageBox.Show("Valor invalido. Ex: 9.99","Validacao",
                        MessageBoxButtons.OK,MessageBoxIcon.Warning);
        ...
        private void BtnSalvar_Click(object sender, EventArgs e)
        {
            ...
            if (_produtoEdicao==null) DatabaseHelper.InserirProduto(produto);
            else                      DatabaseHelper.AtualizarProduto(produto);
